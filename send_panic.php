...
<html>
  ...
  <body>
    <center>
    <h1>If your are able to please Call 911 immediatley </h1>
...
<?php
    ...
    include "twilio-php/Twilio/autoload.php" ;
    ...
    foreach ($people as $number => $name) {
        ...
        //$notification = "Hey $name, Monkey Party at 6PM. Bring Bananas! . Ohana Restuarant - Alanya - Turkey !"
            ...
            array(
                ...
                'body' => "Hey $name,There is an emergency now at the Reception
                ,COME NOW URGENTLY !!!. Sent on $date .
                Ohana Hotel Managemet Group"
